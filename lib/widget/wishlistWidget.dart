...
import 'package:keep_app/controller/shareProductsController.dart';
...
class _MyWishComponetState extends State<MyWishComponet> {
  ...
  void add() {
    ...
    shareProductController.removeWishList(productId:widget.wishdata.productId!);
  }
  ...
  void initState() {
    setState(() {
      productQty =
          double.parse("${widget.wishdata.packInfo![0].productdetailQty}");
              ...
              children: [
                Padding(
                    ...
                    child: Padding(
                      ...
                      child: Image.network(
                        IMAGE_URL + (widget.wishdata.packInfo![0].productdetailImages![0]),
                        width: 100,
                        height: 120,
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("${widget.wishdata.productName}",
